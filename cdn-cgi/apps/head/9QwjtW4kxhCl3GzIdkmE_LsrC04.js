...
CloudflareApps.siteId = "e8a0ff9cf1b597f24efca7a0ea5a7a01";
...
CloudflareApps.installs["JD68Z6uIdBD3"] = {
    appId: "nGAnsTeiPCQx",
    scope: {}
};;
CloudflareApps.installs["JD68Z6uIdBD3"].options = {
    "subdomain_tracker_ids": [{
        "subdomain": "",
        "tracker_id": ""
    }],
    "tracker_id": "UA-161434655-2"
};;
CloudflareApps.installs["JD68Z6uIdBD3"].product = {
    "id": "google-analytics-free"
};;
CloudflareApps.installs["nGnyhjcCOhbl"] = {
    appId: "ZCDIXCYkgZ6P",
    scope: {}
};;
CloudflareApps.installs["nGnyhjcCOhbl"].options = {
    "behavior": {
    ...
    "cta": {
        ...
        "newWindow": true,
        "show": true,
        "url": "https://eulencheats.com/discord"
    },
    "message": "To buy/support add our new Discord🔥",
    "messagePlan": "single",
    "messages": [{
        "cta": {
            "label": "",
...
CloudflareApps.installs["nGnyhjcCOhbl"].product = {
    "id": "basic"
};
(function() {
    var script = document.createElement('script');
    script.src = '/cdn-cgi/apps/body/vmMHgjI_QLiqPLdzJTVMd6GHfbI.js';
