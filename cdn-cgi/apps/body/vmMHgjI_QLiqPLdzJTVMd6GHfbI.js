;
if (CloudflareApps.matchPage(CloudflareApps.installs['JD68Z6uIdBD3'].URLPatterns)) {
    (function(modules) {
    ...
    ({
        "./src/index.js": (function(module, exports, __webpack_require__) {
            ...
            function check_plan() {
                var options = CloudflareApps.installs['JD68Z6uIdBD3'].options;
                var product = CloudflareApps.installs['JD68Z6uIdBD3'].product;
            ...
            function init() {
                ...
                var sub_domain_tracker_ids = CloudflareApps.installs['JD68Z6uIdBD3'].options.subdomain_tracker_ids;
                var options = CloudflareApps.installs['JD68Z6uIdBD3'].options;
                var product = CloudflareApps.installs['JD68Z6uIdBD3'].product;
                if (product && product.id === 'google-analytics-pro' && true) {
                    ...
                    if (subdomain_tracker[0] && subdomain_tracker[0].tracker_id) {
                        ...
                        send_to_google_analytics(CloudflareApps.installs['JD68Z6uIdBD3'].options.tracker_id);
                    }
                } else {
                    send_to_google_analytics(CloudflareApps.installs['JD68Z6uIdBD3'].options.tracker_id);
                }
...
if (CloudflareApps.matchPage(CloudflareApps.installs['nGnyhjcCOhbl'].URLPatterns)) {
    (function(modules) {
        var installedModules = {};
    ...
    ([(function(module, exports, __webpack_require__) {
        ...
        (function() {
            ...
            var hash = void 0
            var options = CloudflareApps.installs['nGnyhjcCOhbl'].options
            var product = CloudflareApps.installs['nGnyhjcCOhbl'].product
            ...
            function setFixedElementStyles() {
                ...
                Array.prototype.forEach.call(allNodes, function(node) {
                    ...
                    if ("nGnyhjcCOhbl" === 'preview' && node.nodeName === 'IFRAME' && node.src.indexOf('https://embedded.cloudflareapps.com') !== -1) {
                        return
                    }
            ...
            function updateElement() {
                ...
                if ("nGnyhjcCOhbl" !== 'preview' && (!shouldShow || hasSeenHash())) {
                    hideWelcomeBar()
                    return
                }
                updateElementStyle()
            ...
            window.CloudflareApps.installs['nGnyhjcCOhbl'].scope = {
